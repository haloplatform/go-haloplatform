...
var (
	...
	nodeFlags = []cli.Flag{
		...
		utils.MaxTxsPerBlockFlag,
		utils.MaxTxsPerAccountFlag,
		utils.TxbPendingMaxFlag,
		utils.TxbQueuedMaxFlag,
		utils.TxbPushMaxFlag,
		utils.TxbMaxBuffFlag,
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	// GLO: Disable non-raft nodes mining
	// TODO: remove
	return
