...
echo ""
echo ""
echo "Go Halo Platform - Binary Install - Mac"
...
echo "############################################################"
curl https://binaries.haloplatform.tech/glo/latest-mac-x64.tar.gz --output latest-mac-x64-temp.tar.gz
...
echo "############################################################"
tar -zxvf latest-mac-x64-temp.tar.gz
...
echo "############################################################"
mv glo-*-mac-x64 /usr/local/bin/glo
