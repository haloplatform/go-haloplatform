...
var (
	HaloMainnetNetworkId = uint64(42566246638)
	HaloTestnetNetworkId = uint64(42568378638)
)

var (
	MainnetGenesisHash = common.HexToHash("0x364089a7a1588f57ad0c66a8449149f0db94e011232d3e36cb50cf2fc969f001") // Mainnet genesis hash to enforce below configs on
	TestnetGenesisHash = common.HexToHash("0x9de26d14afccc3f783746c2064fa7da8eb717b784d2754c684d57a232f657139") // Testnet genesis hash to enforce below configs on
)

var (
	// The address for receiving MN reward
	MasterNodeRewardAddress          = common.HexToAddress("0xee3c8095994d59e5601016a0316e4e607054d58c")
	...
	MasterNodeRewardDelay            = time.Hour * 10 // Deplay in minting reward
)

var (
	// MainnetChainConfig is the chain parameters to run a node on the main network.
	MainnetChainConfig = &ChainConfig{
		ChainId:         big.NewInt(int64(HaloMainnetNetworkId)),
		HomesteadBlock:  nil,
		DAOForkBlock:    nil,
...
type ChainConfig struct {
	...
	RewardTimestamp int64         `json:"rewardTimestamp,omitempty"`
}
